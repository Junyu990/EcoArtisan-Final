<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateSphere.aspx.cs" Inherits="EcoArtisanFinal.UpdateSphere" %>
    ...
    <div class="form-container">
        ...
        <div class="form-body">
            <div class="form-group">
                <label for="tb_SphereID">Sphere ID:</label>
                <asp:TextBox ID="tb_SphereID" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="form-group">
            ...
            <div class="form-actions">
                <asp:Button ID="Btn_update" runat="server" OnClick="Btn_update_Click" Text="Update" CssClass="btn btn-update" />
                <asp:HyperLink ID="HyperLinkManageSphere" runat="server" NavigateUrl="~/ManageUserSphere.aspx" CssClass="btn btn-manage">Go back to record table</asp:HyperLink>
            </div>
        </div>
    </div>
<script>
